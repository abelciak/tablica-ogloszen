...
<div class="wrapper row2">
  <div id="container" class="clear">
    ...
    <div id="content">
	  ...
	  <h2>Panel zarządzania ogłoszeniami</h2>
		<?
		$akcja=$_GET['akcja'];
		
		$resultOgl = mysql_query("SELECT count(*) FROM ogloszenia");
		...
		else if ($akcja=='edytuj')
		{
			...
			<center>
				...
				<form method="post" action="panel.php?akcja=edytuj&id=<?=$numer?>&stan=edycja" name="formularz"> 
				 <table><center>
		...
		$queryPoczatek= "SELECT * FROM ogloszenia   ORDER BY `data`  DESC";
		...
		while($row=mysql_fetch_array($resultPoczatek)) //pobieranie z bazy
		{
			...
			echo "<figcaption>
                  ...
                  <p>{$tresc}</p>
                  <footer class='more'><a href='panel.php?akcja=edytuj&id={$idOgloszenie}'>Edytuj</a> || ";
				  ?>
				...
				<font color='blue'><b>Jesteś pewień, że chcesz usunąć ogłoszenie?</b></font><br><a href='panel.php?akcja=usun&id=<?=$idOgloszenie;?>'><font color='red'><b>TAK</b></font></a>   &nbsp;&nbsp;&nbsp;&nbsp;
